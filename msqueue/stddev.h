...
/* Using double here is not a good idea in general. Use with
 * caution.*/
struct stddev {
	double sum;
	double sum_sq;
...
/* stddev_remove and stddev_modify make no sense with 'double' arguments */
/* static inline void stddev_remove(struct stddev *sd, double old_value) { */
/* 	sd->count--; */
/* 	sd->sum -= old_value; */
/* 	sd->sum_sq -= old_value * old_value; */
/* } */

/* static inline void stddev_modify(struct stddev *sd, double old_value, */
/* 				 double new_value) { */
