...
func NewFragSender(mtu int) *fragSender{
	fs := &fragSender{}
	fs.mtu = mtu
	...
	// syscall.SetsockoptInt(fragFd, syscall.IPPROTO_IP, syscall.IP_MTU, mtu)
	//syscall.SetsockoptInt(fragFd, syscall.IPPROTO_IP, syscall.IP_MTU_DISCOVER, syscall.IP_PMTUDISC_DONT)
...
//	syscall.SetsockoptInt(fragv6Fd, syscall.IPPROTO_IP, IP_NODEFRAG, 1)
	syscall.SetsockoptInt(fragv6Fd, syscall.SOL_SOCKET, syscall.SO_MARK, 33)
	// syscall.SetsockoptInt(fragv6Fd, syscall.IPPROTO_IPV6, syscall.IPV6_MTU, mtu)
	// syscall.SetsockoptInt(fragv6Fd, syscall.IPPROTO_IPV6, syscall.IPV6_MTU_DISCOVER, syscall.IP_PMTUDISC_WANT)
